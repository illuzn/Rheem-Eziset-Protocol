...
[
    ...
    },
    {
        ...
        "type": "function",
        "z": "3c93a6b23de0cde5",
        "name": "Rewrite msg to retrieve entity",
        "func": "msg.payload = { \"path\": \"/api/states/\" + msg.entity };\nreturn msg;",
        "outputs": 1,
        "noerr": 0,
        "initialize": "",
        "finalize": "",
    ...
    },
    {
        ...
        "ret": "obj",
        "paytoqs": "ignore",
        "url": "http://192.168.XXX.XXX/getInfo.cgi",
        "tls": "",
        "persist": false,
        "proxy": "",
        "authType": "",
    ...
    },
    {
        ...
        "type": "ha-entity",
        "z": "0696dd904aa6c7de",
        "name": "Hot Water Switch - Google Helper",
        "server": "f1028730287dd073",
        "version": 2,
        "debugenabled": false,
        "outputs": 2,
        "entityType": "switch",
        "config": [
            ...
            {
                "property": "icon",
                "value": "mdi:kettle-steam-outline"
            },
            {
    ...
    },
    {
        ...
        "type": "inject",
        "z": "0696dd904aa6c7de",
        "name": "Hot Water Switch Update Worker",
        "props": [
            {
                "p": "payload"
            }
    ...
    },
    {
        ...
        "halt_if_type": "str",
        "halt_if_compare": "is",
        "entity_id": "input_number.hot_water_temperature",
        "state_type": "str",
    ...
    },
    {
        ...
        "type": "inject",
        "z": "0696dd904aa6c7de",
        "name": "Hot Water - Requested vs Actual Temp Worker",
        "props": [
            {
                "p": "payload"
            }
    ...
    },
    {
        ...
        "type": "switch",
        "z": "0696dd904aa6c7de",
        "name": "Compare Requested and Actual",
        "property": "payload",
        "propertyType": "msg",
        "rules": [
            {
                "t": "eq",
                "v": "data.attributes.temp",
                "vt": "msg"
            },
            {
                "t": "else"
    ...
    },
    {
        ...
        "type": "switch",
        "z": "0696dd904aa6c7de",
        "name": "Check if Min Valid",
        "property": "payload",
        "propertyType": "msg",
        "rules": [
            {
                "t": "gte",
                "v": "data.attributes.min",
                "vt": "msg"
            },
            {
                "t": "else"
    ...
    },
    {
        ...
        "type": "switch",
        "z": "0696dd904aa6c7de",
        "name": "Check if Max Valid",
        "property": "payload",
        "propertyType": "msg",
        "rules": [
            {
                "t": "lte",
                "v": "data.attributes.max",
                "vt": "msg"
            },
            {
                "t": "else"
    ...
    },
    {
        ...
        "type": "change",
        "z": "0696dd904aa6c7de",
        "name": "Store it in flow.temperature",
        "rules": [
            {
                "t": "set",
                "p": "temperature",
    ...
    },
    {
        ...
        "type": "http request",
        "z": "0696dd904aa6c7de",
        "name": "Take Control of Rheem System",
        "method": "GET",
        "ret": "obj",
        "paytoqs": "ignore",
        "url": "http://192.168.XXX.XXX/ctrl.cgi?sid=0&heatingCtrl=1",
        "tls": "",
        "persist": false,
        "proxy": "",
        "authType": "",
    ...
    },
    {
        ...
        "type": "change",
        "z": "0696dd904aa6c7de",
        "name": "Store Session ID in flow.sid",
        "rules": [
            {
                "t": "set",
                "p": "sid",
    ...
    },
    {
        ...
        "type": "switch",
        "z": "0696dd904aa6c7de",
        "name": "Check for Error State",
        "property": "payload.reqtemp",
        "propertyType": "msg",
        "rules": [
            {
                "t": "eq",
    ...
    },
    {
        ...
        "z": "0696dd904aa6c7de",
        "name": "Automation - Hot Water Timeout",
        "server": "f1028730287dd073",
        "version": 4,
        ...
        "haConfig": [
            {
                "property": "name",
                "value": "Automation - Hot Water Timeout"
            },
            {
                "property": "icon",
                "value": "mdi:kettle-steam-outline"
        ...
        "entityidfilter": "input_number.hot_water_temperature",
    ...
    },
    {
        ...
        "type": "delay",
        "z": "0696dd904aa6c7de",
        "name": "Wait 5 Seconds and Recheck",
        "pauseType": "delay",
        "timeout": "5",
        "timeoutUnits": "seconds",
        "rate": "1",
